...
[![x-cmd/install — gping Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gping.svg?lang=zh)](https://x-cmd.com/install/gping)
...
合计: **1,853** 行代码（覆盖前 5 种语言、共 **30** 个文件）。
...
- **上游仓库**: <https://github.com/orf/gping>
- **许可证**: MIT

## 发布

- **最新版本**: `gping-v1.21.0` (2026-08-31)
- **最近提交**: 2026-09-22
- **Release 含资产**: 11 个

## 流行度

- **Star**: 12,692 · **Fork**: 367 · **开放 issue**: 169 · **贡献者**: 61

## 累计统计

- **发布数**: 48 · **已合并 PR**: 213 · **开放 PR**: 7 · **已关闭 issue**: 134 · **开放 issue**: 35 · **提交数**: 768

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 1 | 1 | 3 | 1 | 1 | 16 |
| last60d | 2026-07-27 | 1 | 4 | 3 | 1 | 2 | 17 |
| 90d | 2026-06-27 | 1 | 5 | 3 | 1 | 2 | 17 |
| last180d | 2026-03-29 | 3 | 9 | 3 | 1 | 2 | 29 |
| 360d | 2025-09-30 | 3 | 15 | 3 | 1 | 5 | 34 |
| last720d | 2024-10-05 | 6 | 26 | 6 | 5 | 12 | 97 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gping.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:54:20Z._
